...
/**
 * Interface for the entry point class to the HW in this class. Our client/testing
 * code interfaces with the student solutions through this interface only.
 * <p>
...
public interface FvmFacade {
     ...
     * @param <P> Type of atomic propositions.
     * @param ts The transition system being tested.
     * @param e The sequence that may or may not be an execution fragment of {@code ts}.
     ...
     * @param <P> Type of atomic propositions.
     * @param ts The transition system being tested.
     * @param e The sequence that may or may not be an initial 
     *          execution fragment of {@code ts}.
     * @return {@code true} iff {@code e} is an execution fragment of {@code ts}.
     */
    ...
    /**
     * Checks whether an alternating sequence is a maximal execution fragment 
     * of a {@link TransitionSystem}, as defined in class.
     * @param <S> Type of states.
     * @param <A> Type of actions.
     * @param <P> Type of atomic propositions.
     * @param ts The transition system being tested.
     * @param e The sequence that may or may not be a maximal 
     *          execution fragment of {@code ts}.
     ...
     * @param s A state in {@code ts}.
     * @param a An action.
     * @return All the states that {@code ts} might transitioned from, 
     *         when in {@code s}, and the last action was {@code a}.
     */
     ...
     * @param a An action.
     * @return All the states that {@code ts} might transitioned from, 
     *         when in any state in {@code c}, and the last action was {@code a}.
     */
     ...
     */
    <L, A> TransitionSystem<Pair<L, Map<String, Object>>, A, String>
        transitionSystemFromProgramGraph(
     ...
     */
	<L, A> TransitionSystem<Pair<List<L>, Map<String, Object>>, A, String> 
        transitionSystemFromChannelSystem(ChannelSystem<L, A> cs);
     ...
     */
     <Sts, Saut, A, P> TransitionSystem<Pair<Sts, Saut>, A, P> 
